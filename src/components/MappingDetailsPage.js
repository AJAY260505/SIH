...
const MappingDetailsPage = () => {
  ...
  const { mapping, searchParams, additionalData, searchTerm } = location.state || {};
              ...
              {additionalData && additionalData.ayurveda ? (
                <div className="results-table">
                  <table>
                    ...
                    <tbody>
                      {additionalData.ayurveda.results.map((item, index) => (
                        <tr key={index}>
                          <td>{item.code}</td>
              ...
              {additionalData && additionalData.unani ? (
                <div className="results-table">
                  <table>
                    ...
                    <tbody>
                      {additionalData.unani.results.map((item, index) => (
                        <tr key={index}>
                          <td>{item.code}</td>
                          <td>{item.english_name}</td>
              ...
              {additionalData && additionalData.siddha ? (
                <div className="results-table">
                  <table>
                    ...
                    <tbody>
                      {additionalData.siddha.results.map((item, index) => (
                        <tr key={index}>
                          <td>{item.code}</td>
                          <td>{item.english_name}</td>
